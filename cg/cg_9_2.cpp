#include <stdio.h> #include <stdlib.h> #include <math.h> #include <graphics.h> #include <dos.h>
...
drawwindow(); delay(1000);

drawline(p1, p2); delay(5000); cleardevice();

delay(1000);
p1 = setcode(p1); p2 = setcode(p2);
v = visibility(p1, p2); delay(1000);

switch (v)
{
case 0:
drawwindow(); delay(500); drawline(p1, p2); break;
case 1:
drawwindow(); delay(500); break;
case 2:
p3 = resetendpt(p1, p2); p4 = resetendpt(p2, p1); drawwindow(); delay(500); drawline(p3, p4); break;
}
